                ...
                <div className="col-lg-4 col-md-6 col-sm-6 order-2 order-lg-3">
                  <div className="widget nav-widget">
                    ...
                    <ul>
                      ...
                      <li>
                        <Link to="#">Medical Cannabis </Link>
                      </li>
                      <li>
                        <Link to="#">Edibles</Link>
                      </li>
                      <li>
                        <Link to="#">Topicals</Link>
                      </li>
                      <li>
                        <Link to="#">Cannabis Extract </Link>
                      </li>
                      <li>
                        <Link to="#">Cannabis Accesories </Link>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="row align-items-center">
                <div className="col-md-5">
                  <p className="copyrigt-text text-center text-md-left">
                    Copyright By@<Link to="#">yourwebsite</Link> - 2021
                  </p>
                </div>
