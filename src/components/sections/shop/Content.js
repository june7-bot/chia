          ...
          <div className="product-grid mb-4">
            ...
            <div className="product-image4">
              ...
              <ul className="social">
                ...
                <li>
                  <Link to="#" data-tip="Add to Favourite">
            ...
            <div className="product-content">
              <h4 className="title">
                <Link to={"/shop-details/" + item.id}>{item.shorttitle}</Link>
              </h4>
              <p>{item.title}</p>
              <div className="price">
              ...
              <Link className="add-to-cart" to={"/shop-details/" + item.id}>
                ADD TO CART
              </Link>
            </div>
          </div>
      ...
      return (
        <Fragment key={number}>
          {pageNumbers.length > 1 ? (
            <li className={classNames({ active: activeCondition })}>
              <Link to="#" data-page={number} onClick={this.handleClick}>
                {number}
              </Link>
            </li>
          ) : (
          ...
          <div className="container">
            <div className="cw-section-heading-wrapper">
              <div className="cw-section-heading">
                <h4>
                  Explore<span className="cw-primary-color">New</span>Strain
                </h4>
              </div>
            </div>
